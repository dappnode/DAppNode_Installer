...
install_docker()
{
  ...
  # ----------------------------------------
  [ -f $DCKR_PATH ] || wget -q --show-progress -O $DCKR_PATH $DCKR_URL
  [ -f $LIB1_PATH ] || wget -q --show-progress -O $LIB1_PATH $LIB1_URL
  [ -f $LIB2_PATH ] || wget -q --show-progress -O $LIB2_PATH $LIB2_URL
  [ -f $LIB3_PATH ] || wget -q --show-progress -O $LIB3_PATH $LIB3_URL
