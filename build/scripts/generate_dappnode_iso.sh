...
in-target chmod +x /usr/src/dappnode/scripts/dn_docker_installer.sh ; \
in-target chmod +x /usr/src/dappnode/scripts/load_docker_images.sh ; \
in-target chmod +x /usr/local/bin/docker-compose ; \
in-target /usr/src/dappnode/scripts/dn_docker_installer.sh" | tee -a preseed/hwe-ubuntu-server.seed
...
in-target chmod +x /usr/src/dappnode/scripts/load_docker_images.sh ; \
in-target chmod +x /usr/local/bin/docker-compose ; \
in-target /usr/src/dappnode/scripts/dn_docker_installer.sh" | tee -a preseed/ubuntu-server.seed
