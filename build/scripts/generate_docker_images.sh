...
echo "Cloning & building DNP_HTTPS-PORTAL..."
git clone -b "v${HTTPS-PORTAL_VERSION}" https://github.com/dappnode/DNP_HTTPS-PORTAL
docker-compose -f ./DNP_HTTPS-PORTAL/docker-compose-https.yml build
docker save https-portal.dnp.dappnode.eth:${HTTPS-PORTAL_VERSION} | xz -e9vT0 >/images/https-portal.dnp.dappnode.eth_${HTTPS-PORTAL_VERSION}_linux-amd64.txz
