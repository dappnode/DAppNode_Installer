...
docker save ethforward.dnp.dappnode.eth:${ETHFORWARD_VERSION} | xz -e9vT0 > /images/ethforward.dnp.dappnode.eth_${ETHCHAIN_VERSION}.tar.xz
...
docker save bind.dnp.dappnode.eth:${BIND_VERSION} | xz -e9vT0 > /images/bind.dnp.dappnode.eth_${ETHCHAIN_VERSION}.tar.xz

echo "Cloning & building DNP_WAMP..."
git clone -b 'v${WAMP_VERSION}' https://github.com/dappnode/DNP_WAMP
docker-compose -f ./DNP_BIND/docker-compose-wamp.yml build 
docker save wamp.dnp.dappnode.eth:${WAMP_VERSION} | xz -e9vT0 > /images/wamp.dnp.dappnode.eth_${ETHCHAIN_VERSION}.tar.xz
